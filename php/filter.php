...
echo "
   <div>
      <label for=\"filter-month\" style=\"font-size: 20px;\">Період</label>
      <input type=\"month\" name=\"filter-month\" id=\"filter-month\">
   </div>
...
while ($r < count($sql_type)) {
   ...
   echo "
      <tr>
         ...
         <td style=\"border: none\"><input type=\"checkbox\" name=\"filter-type[]\" value=\"".$sql_type[$r]['type']."\" checked></td>
      </tr>
      ";
   $r++;
}
