...
echo "
   <div>
      <label for=\"filter-month-my-group\" style=\"font-size: 20px;\">Період</label>
      <input type=\"month\" name=\"filter-month-my-group\" id=\"filter-month-my-group\">
   </div>
...
while ($r < count($sql_type)) {
   ...
   echo "
      <tr>
         ...
         <td style=\"border: none\"><input type=\"checkbox\" name=\"filter-type-my-group[]\" value=\"".$sql_type[$r]['type']."\" checked></td>
      </tr>
      ";
   $r++;
}
